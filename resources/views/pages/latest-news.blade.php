@extends('layouts.app')
@section('title', 'Latest News — Nyay Vidhan')
                    ...
                    @forelse($news as $item)
                        <article class="news-card">
                            ...
                            <div class="news-card-body">
                                <h3 class="news-headline"><a href="{{ route('latest-news.show', $item->slug) }}"
                                        class="text-inherit text-decoration-none">{{ $item->title }}</a></h3>
