    ...
    <div class="container">
        <div class="main-content">
            <div class="content-col">
                <h1 class="section-title mt-3"><span class="accent">Expert</span> Opinions</h1>
                <div class="news-grid">
                    ...
                    <article class="news-card">
                        <div class="news-card-img">
                            ...
                            @else
                                <img src="https://images.unsplash.com/photo-1521791136064-7986c2920216?w=400&q=75" alt="{{ $opinion->title }}" />
                            @endif
