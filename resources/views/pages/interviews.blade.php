@extends('layouts.app')
@section('title', 'Interviews — Nyay Vidhan')
                    ...
                    @forelse($interviews as $interview)
                        <article class="news-card">
                            <div class="news-card-img">
                                ...
                                @else<img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&q=75"
                                        alt="{{ $interview->title }}" />
                                @endif
                                <span class="tag navy">Interview</span>
                            </div>
                            <div class="news-card-body">
                                <h3 class="news-headline"><a href="{{ route('interviews.show', $interview->slug) }}"
                                        class="text-inherit text-decoration-none">{{ $interview->title }}</a></h3>
