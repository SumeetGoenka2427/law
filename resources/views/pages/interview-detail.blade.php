    ...
    <div class="container">
        <div class="page-layout">
            <article class="article-detail">
                ...
                @if($interview->image)<div class="mb-4"><img src="{{ asset('storage/'.$interview->image) }}" alt="{{ $interview->title }}" class="img-fluid rounded w-100" /></div>@endif
                @if($interview->excerpt)<p class="text-muted" style="font-size:1.05rem;margin-bottom:1.5rem">{{ $interview->excerpt }}</p>@endif
