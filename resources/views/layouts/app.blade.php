...
<head>
    ...
    <meta property="og:title" content="@yield('og_title', 'TestLaw — India\'s Premier Legal News Portal')" />
    ...
    <meta property="og:site_name" content="TestLaw" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="@yield('og_title', 'TestLaw — India\'s Premier Legal News Portal')" />
    ...
    <div class="search-modal" id="searchModal">
        ...
        <div class="search-modal-inner">
            <form method="GET" action="{{ route('search') }}" class="search-input-wrap">
                <input type="text" name="q" placeholder="Search judgments, articles, case names…" id="searchInput" autocomplete="off" />
