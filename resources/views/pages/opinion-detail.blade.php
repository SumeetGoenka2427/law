    ...
    <div class="container">
        <div class="page-layout">
            <article class="article-detail">
                ...
                @if($opinion->excerpt)
                    <p class="article-excerpt text-muted" style="font-size:1.05rem;margin-bottom:1.5rem;font-style:italic">{{ $opinion->excerpt }}</p>
                @endif

                @if($opinion->image)
                    <div class="article-hero-img mb-4">
                        <img src="{{ asset('storage/'.$opinion->image) }}" alt="{{ $opinion->title }}" class="img-fluid rounded w-100" />
                    </div>
                @endif
