@extends('layouts.app')
@section('title', '#'.$tag->name.' — TestLaw')
@section('meta_description', 'Articles tagged with '.$tag->name.' on TestLaw.')
@section('og_title', '#'.$tag->name.' — TestLaw')
    ...
    <div class="container">
        ...
        <div class="main-content">
            <div class="content-col">
                ...
                <p class="text-muted mb-4">{{ $articles->total() }} article{{ $articles->total() !== 1 ? 's' : '' }} tagged with <strong>#{{ $tag->name }}</strong></p>
